...
async def test_onde_foi_contrato_sp(client) -> None:
    ...
    # denominador base-única (ADR-0026/0029): % e empenhado_base sobre as funções divulgadas.
    assert b["empenhado_base"] == 54200
    assert b["liquidado"] == 47800
    assert b["pct"] == 88
    ...
    assert b["empenhado_total"] > b["empenhado_base"]
